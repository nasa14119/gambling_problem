    ...
    <main className="rounded-xl px-2 border-2 border-current border-dashed grid grid-cols-1 grid-rows-2">
      ...
      <span className="flex justify-center items-center h-full">
        <span className="relative rounded-4xl border-2 border-white border-dashed w-full h-[3vh]">
          <span
            className="absolute top-0 left-0 h-full bg-blue-800/10 border-2 border-blue-800 border-dashed rounded-4xl transition-all duration-125 ease overflow-hidden"
            style={{ width: `${rank}%` }}
          ></span>
        </span>
      </span>
